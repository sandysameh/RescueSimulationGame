...
public class Citizen implements Rescuable,Simulatable{
	...
	public String toString() {
		...
		String info="Citizen Info : "+this.name+" ,"+this.age+" ,"+this.nationalID;
		String d="";
		if(this.disaster!=null) {
			if(this.disaster.isActive()==false)
				d="NO DISASTER";
			else {
				if(this.disaster instanceof Infection)
					d="DISASTER : INFECTION"+"\n"+"started in cycle: "+disaster.getStartCycle();
				else
					d="DISASTER : INJURY"+"\n"+"started in cycle: "+disaster.getStartCycle();
			}
		}
