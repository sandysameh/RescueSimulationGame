...
public class Ambulance extends MedicalUnit {
	...
	public void respond(Rescuable r) throws CannotTreatException,IncompatibleTargetException {		
		if(r instanceof ResidentialBuilding) {
			throw new IncompatibleTargetException(this, r, "Ambulance is not responsible for treating buildings");
		}
		if(!(canTreat(r))){
			throw new CannotTreatException(this, r, "There is no injury on this citizen");
		}
